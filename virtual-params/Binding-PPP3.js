...
if (args[1].value) {
  m = args[1].value[0];
  declare(`InternetGatewayDevice.WANDevice.1.WANConnectionDevice.${instanceIndex}.WANPPPConnection.1.X_CT-COM_LanInterface`, null, {value: m});
  declare(`InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnection.${instanceIndex}.X_CMCC_LanInterface`, null, {value: m});
