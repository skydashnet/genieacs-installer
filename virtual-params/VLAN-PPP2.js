...
if (args[1].value) {
  ...
  declare(`InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnection.${instanceIndex}.X_HW_VLAN`, null, {value: m});
  declare(`InternetGatewayDevice.WANDevice.1.WANConnectionDevice.${instanceIndex}.WANPPPConnection.1.X_HW_VLAN`, null, {value: m});
  declare(`InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnection.${instanceIndex}.X_CMCC_VLANIDMark`, null, {value: m});
