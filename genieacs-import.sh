...
apply_ui_customizations() {
    ...
    # 2. Build the new patch block
    {
        ...
        echo "/* BRANDING PATCH */"
        echo '.version::after { content: " | Customized by EtherGig" !important; display: inline !important; color: #38bdf8 !important; font-weight: bold !important; }'
        ...
        if [[ "$THEME" == "vanilla" ]]; then
            ...
            if [[ "$THEME" == "dark" ]]; then
                ...
                echo '#side-menu > ul > li > a:hover, #side-menu > ul > li.active > a, #side-menu > ul > li > a.active { background-color: #333 !important; color: #38bdf8 !important; border-color: #444 !important; }'
                ...
                echo 'button.primary { background-color: #38bdf8 !important; color: #111 !important; }'
                echo 'button.primary:hover { background-color: #0ea5e9 !important; }'
                ...
                echo '.notification.success { background-color: #0c4a6ee6 !important; border-color: #38bdf8 !important; }'
                ...
                echo ':root { --color1: #ddd !important; --color2: #ccc !important; --color3: #fdfdfd !important; --color4: #2563eb !important; --color5: #333 !important; }'
                ...
                echo '#side-menu > ul > li > a:hover { background-color: #2563eb !important; color: #fff !important; }'
                echo 'table.table th { color: #2563eb !important; border-bottom: 2px solid #2563eb !important; }'
                echo 'table.table.highlight > tbody > tr:hover { background-color: #eff6ff !important; }'
                echo 'input, select, textarea, .CodeMirror { background-color: #fff !important; border-color: #ddd !important; }'
                echo 'button.primary { background-color: #2563eb !important; color: #fff !important; }'
                echo 'button.primary:hover { background-color: #1d4ed8 !important; }'
                echo 'span.tag { background-color: #eff6ff !important; background-image: none !important; color: #2563eb !important; border: 1px solid #2563eb !important; padding: 2px 8px !important; }'
            fi
        fi
    } >> "$css_file"
